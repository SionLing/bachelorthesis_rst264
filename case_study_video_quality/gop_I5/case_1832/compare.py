...
def compare_video_to_ref(ref_video_filepath,compare_video_filepath,dir_path_for_save):
    ...
    while(last_frame_could_be_read 600!!!):
        try:
            # print("met")
            # print(capA.get_meta_data())
...
#     print(str(i))
#     compare_single_frame_with_visualisation('/Users/nils/Desktop/ffmpeg_tests/save_pl5.mp4','/Users/nils/Desktop/ffmpeg_tests/save_video_pl_3.mp4',i)


# compare_video_to_ref('/Users/nils/Desktop/ffmpeg_tests/save_pl5.mp4','/Users/nils/Desktop/ffmpeg_tests/save_video_from_python_2.mp4','/Users/nils/Desktop/ffmpeg_tests/')
...
# video1 = project_path + "output/streaming_main.mp4"
# video2 = project_path + "output/packet_loss_main.mp4"
vid1_filepath = "case_1_ref_video.mp4"

for i in range(3):
    for j in [128,256,512,769,1024,1280]:
        vid2_filepath = "packet_loss_simulation_" + str(j) + "_" + str(i) + "video.mp4"
        # print(vid2_filepath)
        threading.Thread(target=compare_video_to_ref, args=(vid1_filepath, vid2_filepath,"")).start()
